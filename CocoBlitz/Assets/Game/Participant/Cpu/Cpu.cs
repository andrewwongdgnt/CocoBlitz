...
public class Cpu : Participant
{
    ...
    public static readonly Cpu KELSEY = new Builder()
        ...
        .DelayLowerRangeBeforeAnswer(1.0f)
        .DelayUpperRangeBeforeAnswer(2.5f)
    ...
    public static readonly Cpu ANDREW = new Builder()
        ...
        .DelayLowerRangeBeforeAnswer(0.8f)
        .DelayUpperRangeBeforeAnswer(2.25F)
        .ChanceOfCorrectForCorrectlyColored(80)
    ...
    public static readonly Cpu MONKEY = new Builder()
        ...
        .DelayLowerRangeBeforeAnswer(0.9f)
        .DelayUpperRangeBeforeAnswer(2.3F)
        .ChanceOfCorrectForCorrectlyColored(91)
        .ChanceOfCorrectForIncorrectlyColored(73)
        .IsStarter()
        .Build();
    public static readonly Cpu PENGUIN = new Builder()
        ...
        .DelayLowerRangeBeforeAnswer(1.1f)
        .DelayUpperRangeBeforeAnswer(2.1F)
        .ChanceOfCorrectForCorrectlyColored(80)
        .ChanceOfCorrectForIncorrectlyColored(75)
        .IsStarter()
        .Build();
    public static readonly Cpu KONGO = new Builder()
        ...
        .ChanceOfCorrectForIncorrectlyColored(95)
        .Build();
    public static readonly Cpu PURPLE_MONKEY = new Builder()
        ...
        .ChanceOfCorrectForCorrectlyColored(75)
        .ChanceOfCorrectForIncorrectlyColored(70)
        .Build();
    public static readonly Cpu MUFFIN = new Builder()
        ...
        .ChanceOfCorrectForCorrectlyColored(80)
        .ChanceOfCorrectForIncorrectlyColored(70)
        .DelayModiferDict(new Dictionary<CardUtil.EntityEnum, float> { { CardUtil.EntityEnum.Coco, -0.35f } })
    ...
    public static readonly Cpu CHOMP = new Builder()
        ...
        .UnlockDescription("To unlock, check out the Coco Store!")
        .DelayLowerRangeBeforeAnswer(1.1f)
        .DelayUpperRangeBeforeAnswer(2.2F)
    ...
    public static readonly Cpu COCO = new Builder()
        ...
        .UnlockDescription("To unlock, check out the Coco Store!")
        .DelayLowerRangeBeforeAnswer(.9f)
        .DelayUpperRangeBeforeAnswer(2.1F)
        .ChanceOfCorrectForCorrectlyColored(95)
        .ChanceOfCorrectForIncorrectlyColored(85)
        .DelayModiferDict(new Dictionary<CardUtil.EntityEnum, float> { { CardUtil.EntityEnum.Coco, -0.7f } })
        .ChanceOfCorrectModiferDict(new Dictionary<CardUtil.EntityEnum, float> { { CardUtil.EntityEnum.Coco, 8 } })
        .Build();
